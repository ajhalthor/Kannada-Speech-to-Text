...
with open('short/syl/wlist_short.txt','w+') as wout:
	for w in short_wlist:
		wout.write("{}\n".format(w))

with open('middle/syl/wlist_middle.txt','w+') as wout:
	for w in middle_wlist:
		wout.write("{}\n".format(w))

with open('long/syl/wlist_long.txt','w+') as wout:
	for w in long_wlist:
		wout.write("{}\n".format(w))
